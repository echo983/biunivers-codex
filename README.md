...
- Each user turn is limited to eight tool calls. Provider failures use a short backoff and are attempted at most three times before becoming a visible terminal answer, preventing nested retry storms while tolerating isolated empty responses.
