...
test("generates a provider config without persisting the secret", async () => {
  ...
  assert.match(content, /env_key = "BIUNIVERS_MODEL_API_KEY"/);
  assert.match(content, /BIUNIVERS_MODEL_API_KEY = false/);
